...
import { Mail, Sparkles, CheckCircle, Users, Search, FileText, Megaphone } from "lucide-react";
...
const mobileServices = [
  { name: "SEO", icon: <Search className="h-5 w-5 text-blue-600" /> },
  { name: "Content Strategy", icon: <FileText className="h-5 w-5 text-blue-600" /> },
  { name: "Social Media", icon: <Users className="h-5 w-5 text-blue-600" /> },
  { name: "Paid Ads", icon: <Megaphone className="h-5 w-5 text-blue-600" /> },
];
...
function MobileStatusBar() {
  ...
  return (
    <motion.div
      className="w-full max-w-xs mx-auto p-3 bg-white/60 backdrop-blur-sm border border-gray-200/80 rounded-xl shadow-lg flex items-center justify-between gap-3 md:hidden"
      ...
      <main className="flex-1 relative overflow-hidden">
        ...
        <section className="relative w-full py-20 md:py-32 lg:py-40 xl:py-28 flex items-start justify-center text-center z-10">
            ...
            >
              ...
              <div className="md:hidden w-full max-w-md mx-auto">
                <motion.div
                  ...
                  variants={pillWrapperVariants}
                >
                  {mobileServices.map((service) => (
                    <motion.div
                      key={service.name}
                      className="flex items-center justify-center gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg shadow-sm"
          ...
          <motion.div
            ...
            custom={{ delay: 0.5 }}
            variants={desktopFloatingCardVariants}
            initial="hidden"
            animate="visible"
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="h-1.5 bg-gray-200 rounded-full mt-1"><div className="h-full bg-blue-500 rounded-full w-[75%]" /></div>
                    <p className="text-xs text-gray-500 mt-1">Due: Today</p>
                  </div>
                  <div className="flex -space-x-2 overflow-hidden">
                    <Image src="/placeholder.svg?height=24&width=24" width={24} height={24} alt="Avatar" className="inline-block h-6 w-6 rounded-full ring-2 ring-white" />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="h-1.5 bg-gray-200 rounded-full mt-1"><div className="h-full bg-blue-500 rounded-full w-[90%]" /></div>
            ...
            <motion.div animate={{ y: [0, -4, 0] }} transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut", delay: 0.8 }}>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-gray-100 p-3 rounded-lg flex items-center justify-center">
                  <Image src="/placeholder.svg?height=48&width=48" width={48} height={48} alt="Google Analytics" className="w-12 h-12 object-contain" />
                </div>
                <div className="bg-gray-100 p-3 rounded-lg flex items-center justify-center">
                  <Image src="/placeholder.svg?height=48&width=48" width={48} height={48} alt="Mailchimp" className="w-12 h-12 object-contain" />
                </div>
                <div className="bg-gray-100 p-3 rounded-lg flex items-center justify-center">
                  <Image src="/placeholder.svg?height=48&width=48" width={48} height={48} alt="Facebook Ads" className="w-12 h-12 object-contain" />
                </div>
              </div>
            </motion.div>
          </motion.div>
