...
export const FooterTapedDesign = () => {
  ...
  return (
    <footer className="my-8 px-4 max-w-7xl text-gray-700 mx-auto">
      <div className="relative bg-white rounded-3xl max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center gap-6 shadow-lg">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-4 md:gap-10 px-2 md:px-8 flex-1">
          <div className="flex flex-col items-start gap-2">
            <Link href="/" className="flex flex-row gap-1 items-center justify-start text-2xl font-bold text-gray-900">
              ImpactFlow Marketing
            </Link>
            <p className="text-gray-600 font-medium text-base w-full md:w-4/5">
              Strategic marketing solutions that amplify your brand and drive measurable growth for solo entrepreneurs
          ...
          <div className="flex flex-col md:mx-4 md:flex-row gap-2 md:gap-20 items-start md:items-start">
            <div className="flex flex-col gap-1 md:gap-4">
              <h4 className="uppercase font-semibold text-md text-gray-500 font-semibold">Services</h4>
              <div className="flex flex-wrap md:flex-col gap-2 text-sm text-gray-600 items-start">
                <Link
                  className="text-gray-600 hover:text-blue-600 whitespace-nowrap font-medium transition-colors"
                  href="/services"
                >
            ...
            <div className="flex flex-col gap-1 md:gap-4">
              <h4 className="uppercase whitespace-nowrap font-semibold text-md text-gray-500 font-semibold">Company</h4>
      ...
      <div className="my-3 px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm text-gray-600">
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-8 items-start sm:items-center">
          <p className="whitespace-nowrap">©{currentYear} ImpactFlow Marketing. All rights reserved.</p>
        ...
        <div className="flex gap-4 items-center">
          <a
            href="mailto:hello@impactflowmarketing.com"
            target="_blank"
            rel="noreferrer nofollow noopener"
            aria-label="Email ImpactFlow Marketing"
            className="hover:text-blue-600 transition-colors"
          >
            <Mail className="w-5 h-5" />
          </a>
          <a
            href="https://www.linkedin.com/company/impactflow-marketing"
            target="_blank"
            rel="noreferrer nofollow noopener"
            aria-label="ImpactFlow Marketing LinkedIn"
            className="hover:text-blue-600 transition-colors"
          >
            <Linkedin className="w-5 h-5" />
          </a>
          <a
            href="https://twitter.com/impactflowmktg"
            target="_blank"
            rel="noreferrer nofollow noopener"
            aria-label="ImpactFlow Marketing Twitter"
            className="hover:text-blue-600 transition-colors"
          >
            <Twitter className="w-5 h-5" />
          </a>
          <a
            href="https://instagram.com/impactflowmarketing"
            target="_blank"
            rel="noreferrer nofollow noopener"
            aria-label="ImpactFlow Marketing Instagram"
            className="hover:text-blue-600 transition-colors"
          >
